...
([xshift=3cm,yshift=-8cm]current page.center) rectangle ++ (4.2,7.7);
...
\end{scope}
%
\fill[c1] ([xshift=3cm,yshift=-8cm]current page.center) rectangle ++ (-13.7,7.7);
\node[text=white,anchor=west,scale=3.5,inner sep=0pt] at
([xshift=-10cm,yshift=-1.5cm]current page.center) {Dynamics of Quasi-Stable};
\node[text=white,anchor=west,scale=3.5,inner sep=0pt] at
([xshift=-10cm,yshift=-3cm]current page.center) {Dissipative Systems};
\node[text=white,anchor=west,scale=4,inner sep=0pt] at
([xshift=-10cm,yshift=-4.8cm]current page.center) {学习指南};
 学习指南
\node[text=white,anchor=west,scale=1.5,inner sep=0pt] at
 ([xshift=-3cm,yshift=-6.3cm]current page.center) {Igor Chueshov };
\node[text=white,anchor=west,scale=1.2,inner sep=0pt] at
([xshift=-0.6cm,yshift=-7cm]current page.center) {沈卓洋};
\node[text=white,anchor=west,scale=1.5,inner sep=0pt] at
([xshift=2cm,yshift=-6.3cm]current page.center) {著};
\node[text=white,anchor=west,scale=1.5,inner sep=0pt] at
([xshift=2cm,yshift=-7cm]current page.center) {编};
\end{tikzpicture}